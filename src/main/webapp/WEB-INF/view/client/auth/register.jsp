                                    ...
                                    <div class="col-lg-7">
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            <div class="card-header bg-success">
                                                <h3 class="text-center font-weight-light my-4 text-white">Create Account
                                                </h3>
                                            </div>
                                            <div class="card-body">
                                                <form:form action="/register" method="POST"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-floating mb-3 mb-md-0">
                                                                <form:input
                                                                    ...
                                                                    pass="confirmPassword" path="confirmPassword" />
                                                    ...
                                                    <div class="mt-4 mb-0">
                                                        <button type="submit" class="d-grid btn btn-success btn-block ">
                                                            Create Account
                                                        </button>
                                            ...
                                            <div class=" card-footer text-center py-3">
                                                <div class="small"><a href="login.html">Have an account? Go
                                                        to login</a>
                                                </div>
                                            </div>
                                        </div>

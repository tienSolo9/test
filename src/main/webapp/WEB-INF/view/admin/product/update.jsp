                        ...
                        <form:form action="/admin/product/update" method="POST" modelAttribute="productDetail"
                            ...
                            <div class="row mx-auto col-md-6">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <form:input class="form-control ${not empty eName?'is-invalid':''}" path="name" />
                                    <form:errors path="name" cssClass="invalid-feedback" />
                                </div>
                                <div class="mb-3 col-6">

                                    <label for="" class="form-label">Price</label>
                                    <form:input class="form-control ${not empty pName?'is-invalid':''}" type="number"
                                        step="any" path="price" />
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <form:input class="form-control ${not empty qName?'is-invalid':''}" type="number"
                                        path="quantity" />
                                ...
                                <div class="col-12 mb-3">
                                    <img id="avatarPreview" style="max-height: 250px;"
                                        src="/images/laptop/${productDetail.image}">
                                </div>
                                <div class="">
